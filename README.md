# Football AI Coach — Editorial Closed Beta V7.3

Mobile-first football development app using the existing **React + Vite frontend** and **Node/Express backend**. V7.3 keeps the V7.2 coaching, safety and resilience layer intact while replacing the visual direction with a **premium editorial football system: warm ivory surfaces, matte-black performance cards, electric-lime actions, condensed sports typography and a session-first mobile hierarchy**.


## What V7.3 changes

- **Editorial football identity:** warm off-white/ivory base, matte black high-priority cards and controlled electric-lime emphasis replace the previous navy/blue/glass-heavy presentation.
- **Session-first Home:** Today’s Session now appears before Daily Check-in so returning players can understand and start the day’s work immediately.
- **Stronger sports typography:** Barlow Condensed drives display headlines while Inter remains the UI/body face.
- **Focused workout mode:** workout screens stay deliberately dark with lime timing/progress accents and minimal distraction.
- **Consistent mobile hierarchy:** Plan, Progress, Profile, onboarding, sheets and bottom navigation now share one reusable visual language from 320–430px.
- **No coaching rewrite:** planner rules, validated exercises, progression, safety constraints, offline behavior, persistence and analytics logic remain V7.2-compatible.
